...
function compileShaderProgram(vPath: string, fPath: string, gl: WebGL2RenderingContext): Promise<WebGLProgram | null> {
...
function attachShaderFromSource(source: string, program: WebGLProgram, gl: WebGL2RenderingContext, type: number): boolean {
